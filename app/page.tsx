...
export default function HomePage() {
  return (
    <main className="bg-[#f9f9f9] dark:bg-black text-black dark:text-white min-h-[100svh] flex flex-col w-full overflow-x-hidden selection:bg-[#FFDD00] selection:text-black">
          ...
          <div className="relative z-10 w-full h-full flex flex-col flex-1 justify-between max-w-7xl mx-auto">
            ...
            <div className="w-full flex flex-col items-center justify-center text-center flex-1 my-8 drop-shadow-xl">
              <div className="animate-fade-up delay-100 w-full flex flex-col items-center px-[10px] gap-1 sm:gap-4">
                <h1 className="font-extrabold text-black dark:text-white tracking-tight leading-[1.1] text-center w-full sm:whitespace-nowrap" style={{ fontSize: "clamp(3.18rem, 5.5vw, 6rem)" }}>
                  Greeting for <span>every</span> moment.
                </h1>
                <p className="font-medium text-black/90 dark:text-white/90 mt-2 text-center drop-shadow-md" style={{ fontSize: "clamp(0.80rem, 1.8vw, 1.15rem)" }}>
            ...
            <div className="w-full flex pb-2 sm:pb-4">
              <Link href="/download-app" className="group inline-flex items-center gap-3 rounded-full bg-white px-7 py-3.5 sm:px-8 sm:py-4 shadow-sm transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-md">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {/* Large Feature Card */}
          <div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 p-8 md:p-12 transition-all duration-300 ease-out hover:-translate-y-1 hover:border-[#FFDD00] dark:hover:border-[#FFDD00] hover:shadow-[0_8px_30px_rgba(255,221,0,0.15)] animate-fade-up delay-100">
            <div className="relative z-10 max-w-md">
              <h3 className="text-2xl md:text-3xl font-bold mb-3">One-tap sharing to anywhere.</h3>
          ...
          <div className="group relative rounded-3xl bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 p-8 transition-all duration-300 ease-out hover:-translate-y-1 hover:border-[#FFDD00] dark:hover:border-[#FFDD00] hover:shadow-[0_8px_30px_rgba(255,221,0,0.15)] animate-fade-up delay-150">
            <div className="flex flex-col justify-end h-full">
              <h3 className="text-xl font-bold mb-2">10,000+ HD Cards</h3>
          ...
          <div className="group relative rounded-3xl bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 p-8 transition-all duration-300 ease-out hover:-translate-y-1 hover:border-[#FFDD00] dark:hover:border-[#FFDD00] hover:shadow-[0_8px_30px_rgba(255,221,0,0.15)] animate-fade-up delay-200">
            <div className="flex flex-col justify-end h-full">
          ...
          {/* Wide Feature Card */}
          <div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-gray-50 dark:bg-[#18181b] border border-gray-200 dark:border-white/10 p-8 md:p-12 transition-all duration-300 ease-out hover:-translate-y-1 hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-[0_8px_30px_rgba(66,133,244,0.15)] animate-fade-up delay-300">
            <h3 className="text-2xl md:text-3xl font-bold mb-3">Download the Android App</h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-y border-gray-200 dark:border-white/10 bg-white dark:bg-[#111]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 text-center md:text-left">
            {[
              ...
              <div key={i} className="relative animate-fade-up" style={{ animationDelay: `${i * 150}ms` }}>
                <span className="text-6xl md:text-8xl font-black text-gray-100 dark:text-[#222] absolute -top-8 left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0 pointer-events-none">
                  {step.num}
                </span>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center animate-fade-up">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-4 text-lg max-w-2xl font-medium">
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4 w-full sm:w-auto">
            <Link
              href="/support"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 rounded-full bg-[#FFDD00] text-black px-8 py-4 font-bold text-base shadow-sm hover:scale-105 active:scale-95 transition-all duration-300 hover:shadow-md"
            >
            ...
            <Link
              href="/careers"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full border-2 border-gray-200 dark:border-white/20 bg-transparent px-8 py-4 font-bold text-base hover:bg-gray-50 dark:hover:bg-[#111] hover:border-[#FFDD00] dark:hover:border-[#FFDD00] hover:scale-105 active:scale-95 transition-all duration-300"
            >
              Work With Us &rarr;
            </Link>
          </div>
